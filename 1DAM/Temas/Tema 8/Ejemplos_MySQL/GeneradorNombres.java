...
public class GeneradorNombres {
    ...
    //Método que devuelve un nombre aleatoriamente del listado de nombres
    public static String generarNombre() {
        Random random = new Random();
        return NOMBRES[random.nextInt(NOMBRES.length)];
    }

    //Método que devuelve un nombre y un apellido aleatoriamente de los listados anteriormente generados
    ...
    //Método que devuelve un nombre y dos apellido aleatoriamente de los listados anteriormente generados
